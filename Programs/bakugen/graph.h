...
#define PLAYER_NUM 4
#define PLAYER_GRAPH_NUM 5
#define PLAYER_CHIP_NUM 12
enum{
	REIMU=0,MARISA,SAKUYA,REMILIA,FRANDRE
};
#define ITEM_GRAPH_NUM 7
#define FACE_GRAPH_NUM 5
#define NUMBER_GRAPH_NUM 10
#define BACK_GRAPH_NUM 1
#define MAP_GRAPH_NUM 3
#define BOMB_GRAPH_NUM 3
#define SHOT_GRAPH_NUMA 2
#define SHOT_GRAPH_NUMB 8
#define SPELL_GRAPH_NUM 1
#define EFFECT_GRAPH_NUM 3
#define ASCII_NUM 45
#define MENU_GRAPH_NUM 5

extern int gPlayer[PLAYER_GRAPH_NUM][PLAYER_CHIP_NUM];
