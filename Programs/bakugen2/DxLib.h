...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x3030
#define DXLIB_VERSION_STR _T( "3.03" )
...
// エラー処理関数
extern	BOOL		ErrorLogAdd( const TCHAR *ErrorStr ) ;									// エラー文書を書き出す
extern 	BOOL		ErrorLogFmtAdd( const TCHAR *FormatString , ... ) ;						// 書式付きエラー文書を書き出す
...
extern 	BOOL		AppLogAdd( const TCHAR *String , ... ) ;								// 書式付きログ文字列を書き出す
...
extern	int			ChangeFont( const char *FontName, int CharSet = -1 /* DX_CHARSET_SHFTJIS 等 */ ) ;							// フォントを変更
