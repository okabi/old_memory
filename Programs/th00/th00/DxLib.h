...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x300c
#define DXLIB_VERSION_STR "3.00c"
...
extern	int			DrawCapsul3D( VECTOR Pos1, VECTOR Pos2, float r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;											// ３Ｄのカプセルを描画する
